...
# print(df.drop( 'Column5' , axis = 1 )) #df anlık değişir

df.drop( 'Column5' , axis = 1 , inplace= True ) #orjinal df değişir

# df.drop( 'Column5' , axis = 1 , inplace= False ) #orjinal df değişmez
