...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(574, 652)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.btnHobilerSecilenleriAl = QtWidgets.QPushButton(self.centralwidget)
        self.btnHobilerSecilenleriAl.setGeometry(QtCore.QRect(60, 310, 211, 81))
        ...
        self.lblResultHobiler.setGeometry(QtCore.QRect(60, 400, 201, 201))
        ...
        self.groupHobiler.setGeometry(QtCore.QRect(30, 20, 261, 271))
        self.groupHobiler.setObjectName("groupHobiler")
        self.widget = QtWidgets.QWidget(self.groupHobiler)
        self.widget.setGeometry(QtCore.QRect(40, 50, 181, 181))
        ...
        self.groupDersler.setGeometry(QtCore.QRect(300, 20, 261, 271))
        self.groupDersler.setObjectName("groupDersler")
        self.layoutWidget = QtWidgets.QWidget(self.groupDersler)
        self.layoutWidget.setGeometry(QtCore.QRect(40, 50, 181, 181))
        ...
        self.btnDerslerSecilenleriAl.setGeometry(QtCore.QRect(330, 310, 211, 81))
        ...
        self.lblResultDersler.setGeometry(QtCore.QRect(330, 400, 201, 201))
